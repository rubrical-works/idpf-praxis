...
## Overview
IDPF-Chaos is the framework for developing and executing chaos engineering experiments. It extends IDPF-Testing with specialized guidance for resilience testing, fault injection, and failure scenario validation.
...
Define measurable steady state before experiments:
...
### What is a GameDay?
A GameDay is a scheduled event where teams run multiple chaos experiments to validate system resilience, practice incident response, and build confidence in production systems.
