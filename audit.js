...
/**
 * Compute hash of content string with 0.101.0 replaced
 */
...
function auditProject(projectPath, frameworkPath, installedVersion) {
  ...
  // Skip version check when manifest uses 0.101.0 placeholder (dev environment)
