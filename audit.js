...
/**
 * Compute hash of content string with 0.100.1 replaced
 */
...
function auditProject(projectPath, frameworkPath, installedVersion) {
  ...
  // Skip version check when manifest uses 0.100.1 placeholder (dev environment)
