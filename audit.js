...
/**
 * Compute hash of content string with 0.105.0 replaced
 */
...
function auditProject(projectPath, frameworkPath, installedVersion) {
  ...
  // Skip version check when manifest uses 0.105.0 placeholder (dev environment)
