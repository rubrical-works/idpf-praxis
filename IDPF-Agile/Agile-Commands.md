...
2. **Get Description:** User describes the new story
3. **Charter Compliance:** Validate story aligns with CHARTER.md scope
...
1. **Validate Arguments:** Branch must follow `[prefix]/[name]` format
...
Used to cancel/abandon a branch.
1. **Confirm Branch Name:** User must type full branch name
2. **Close Tracker:** Close with "not planned" reason
