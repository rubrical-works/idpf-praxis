...
## Terminology
1. **User Story**: A feature described from the user's perspective with acceptance criteria
...
4. **Definition of Done (DoD)**: Checklist that must be satisfied for a story to be complete

## Agile Workflow
```
Product Backlog Creation
         ↓
Story Selection (from Ready)
         ↓
Story Development (TDD cycles)
         ↓
Story Review (validate acceptance criteria)
         ↓
Done → Next Story or Release
```
...
When needed, Claude will load:
- **Templates** - Backlog, Story, Review formats
- **Commands** - Full command reference with descriptions
- **Best Practices** - Story writing, story selection, development DOs/DON'Ts
- **Transitions** - Moving to Structured or LTS frameworks
