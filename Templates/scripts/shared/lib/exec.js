 ...
 * spawns and silently never fires for async ones. These wrappers normalize both
...
/**
 * Normalize a spawn error so a timeout always carries `code: 'ETIMEDOUT'`.
 *
 ...
 * non-zero exit is never relabeled as a hang.
 *
 ...
 * behavior change well beyond adding a bound.
 *
