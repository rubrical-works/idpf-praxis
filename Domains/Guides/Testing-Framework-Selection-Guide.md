...
**Purpose:** Help teams select the appropriate IDPF testing domain and development methodology.
...
2. Which IDPF testing domain to use
...
**Governance:** Use a domain with its own GitHub Project.
...
└─ NO (Separate testing effort)
    │
    ├─ What type of testing? ──► Select domain
    │
