...
**Location:** `E:\Projects\idpf-praxis\IDPF-Agile\Agile-Driven Development Framework.md`
**Type:** Sprint-Based Development with User Stories

### Purpose
Implement agile software development methodology with AI assistance, organizing work around user stories, sprints, and continuous iteration.
...
- Epic: Large feature area containing multiple stories
...
- **Sprint Commands**: Plan-Sprint, Sprint-Status, Sprint-Retro, End-Sprint
...
**Location:** `E:\Projects\idpf-praxis\IDPF-Vibe\`
...
- Best when: Feature set identified, need sprints/prioritization, team collaboration
...
Test repositories use IDPF-Agile for sprint-based test development with backlog management and velocity tracking.
...
**Location:** `E:\Projects\idpf-praxis\System-Instructions\`
...
**Location:** `E:\Projects\idpf-praxis\Skills\`
**Purpose:** Reusable capabilities for specific tasks
**Total Skills:** 23 (6 TDD/BDD, 1 PRD, 2 code quality, 2 beginner setup, 3 beginner support, 2 database, 2 advanced testing, 2 architecture, 1 DevOps, 1 testing setup, 1 desktop)
...
- **Coverage**: Test parsing (pytest, Jest, JUnit, RSpec), NFR detection from code patterns, architecture inference
- **When Used**: Reverse-PRD workflow, documenting legacy code, creating PRD from as-built
- **Resources**: test-parsing-guide.md, nfr-detection-guide.md, worksheet templates (discovery, elicitation)
- **Integration**: Used by `/create-prd extract` mode
- **Audience**: Experienced developers documenting existing projects
...
- **Integration**: Complements extract-prd for Reverse-PRD workflow (detects technical debt)
...
**Location:** `E:\Projects\idpf-praxis\Assistant\`
...
|----------------|--------------|-------------------|
| **Vibe** | **Agile** | Vibe exploration complete, feature set identified, ready for sprint-based development |
...
- Workflow structure (Exploratory to Sprints)
- Planning granularity (Ideas to Stories)
- Progress tracking (Vibes to Velocity)
...
- **Testing Frameworks**: IDPF-Testing (foundation) + IDPF-QA-Automation + IDPF-Performance + IDPF-Security + IDPF-Accessibility + IDPF-Chaos + IDPF-Contract-Testing
- **System Instructions**: 1 Core + 22 Domain Specialists + 1 Domain Selection Guide + 1 Legacy + Vibe Agent (Core + 6 platforms)
- **23 Skills**: 6 TDD/BDD (experienced), 1 PRD, 2 code quality, 2 beginner setup, 3 beginner support, 2 database, 2 advanced testing, 2 architecture, 1 DevOps, 1 testing setup, 1 desktop
...
- **Frameworks** provide methodology and process (WHAT)
  - Agile: Sprints, user stories, velocity tracking (terminal framework)
  - Vibe: Exploratory, evolves to Agile
  - Testing-Core: Foundation for separate test repositories (QA Automation, Performance, Security, Accessibility, Chaos, Contract Testing)
...
|--------------|---------------|----------------|----------------|
| Defined requirements | IDPF-Agile | Terminal | Sprint-based delivery |
...
| Separate test repository | IDPF-Testing | Agile for test dev | Test automation codebase |
